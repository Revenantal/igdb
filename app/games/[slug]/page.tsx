        ...
        <>
            ...
            { artworks && 
                <div className="absolute inset-0 opacity-30 flex items-center justify-center pointer-events-none -z-10 h-[80vh]">
                    <Image src={`https://images.igdb.com/igdb/image/upload/t_1080p/${artworks[0].image_id}.jpg`} alt={name || 'Game Artwork'}  fill={true} className="object-cover" priority={true}/>
                    ...
                    <div className="grid grid-cols-12 gap-4">
                        ...
                        <Card className="col-span-12 grid grid-cols-5 gap-4 pb-96">
                            {artworks && artworks.map((artwork) => {
                                return <Image key={artwork.id} src={`https://images.igdb.com/igdb/image/upload/t_cover_big/${artwork.image_id}.jpg`} alt="" width={264} height={374} className="rounded" />
                            })}
                        </Card>
                    </div>
                </div>
